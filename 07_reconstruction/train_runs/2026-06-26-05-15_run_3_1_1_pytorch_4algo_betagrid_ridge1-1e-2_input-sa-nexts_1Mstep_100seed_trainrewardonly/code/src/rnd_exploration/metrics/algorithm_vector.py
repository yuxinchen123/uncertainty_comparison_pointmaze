...
# ALGORITHM_NAMES and ALGORITHMS_NO_ACTION now live in rnd_exploration.methods (the registry) — the
# single source of truth. ALGORITHMS_NO_ACTION is imported above; VALID_DISTANCE_ALGORITHMS (the
# distance-metric names) is local to this module.
