...
def main():
    ...
    parser.add_argument("--goal_position", type=str, default="bottom_left", choices=["bottom_left", "top_right", "random"], help="Fixed goal corner: bottom_left or top_right or random")
