...
class WandbEvalLoggingCallback(BaseCallback):
    ...
    def __init__(self, eval_env, eval_freq: int, n_eval_episodes: int, use_wandb: bool, visit_count_env=None, goal_cell=None, start_cell=None, run_name: str = "", beta: float = 0.0, total_timesteps: int = None, n_eval_episodes_final: int = 100, log_to_wandb: bool = None, verbose: int = 0):
