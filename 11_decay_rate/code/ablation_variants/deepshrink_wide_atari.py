...
class Method:
    ...
    name = "deep_lastlayer_shrink_wide"
    ...
    def __init__(self, seed: int, obs_dim=4):
        ...
        self.feat_dim = 1024 if not isinstance(obs_dim, int) else 256
        ...
        self.W = torch.zeros(128, self.feat_dim, dtype=torch.float64, device=self.device)
        self._mean = None
        self._var = None
