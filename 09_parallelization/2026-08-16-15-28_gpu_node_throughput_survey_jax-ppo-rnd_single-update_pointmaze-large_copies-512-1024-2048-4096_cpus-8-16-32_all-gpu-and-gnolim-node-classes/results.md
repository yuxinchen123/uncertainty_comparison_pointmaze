...
Written 2026-08-16 16:22 PT. Times in this document are Pacific; the cluster's machines run Eastern, so every machine timestamp is converted where it is displayed.

57 of 80 jobs have reported, giving 183 measured cells; 32 cells did not fit on their card. 23 jobs are still queued or unrun — every number below is what has arrived, not a complete survey.
...
| `jaguar03` | gpu | RTX A4500 | 8.6 | 20.5 | amd epyc 7663 | 8, 16 | 8/12 |
| `cheetah08-09` | gpu | RTX A4000 | 8.6 | 16.4 | skylake | none yet | 0/12 |
| `jaguar02` | gpu | A16 | 8.6 | 15.4 | icelake | none yet | 0/12 |
| `lotus` | gpu | Quadro RTX 6000 | 7.5 | 24.1 | skylake | 8, 16, 32 | 12/12 |
| `affogato11` | gpu | RTX 2080 Ti | 7.5 | 10.9 | broadwell | none yet | 0/12 |
| `ai01-04_lynx10` | gpu | RTX 2080 Ti | 7.5 | 10.9 | broadwell | 8, 16, 30 | 8/12 |
| `ai06` | gpu | RTX 2080 Ti | 7.5 | 10.9 | broadwell | 8, 16, 30 | 8/12 |
...
| `lynx05-07` | gpu | Tesla P100 | 6.0 | 12.2 | broadwell | 8, 16, 30 | 8/12 |
| `lynx01` | gpu | Titan Xp | 6.1 | 12.2 | broadwell | 8, 16 | 6/12 |
| `affogato13-15` | gpu | GTX 1080 Ti | 6.1 | 11.3 | broadwell | 8, 16 | 6/12 |
| `ai07-08` | gnolim | GTX 1080 Ti | 6.1 | 11.3 | skylake | 8, 16, 30 | 8/12 |
| `ai09` | gnolim | GTX 1080 Ti | 6.1 | 11.3 | skylake | 8, 16, 30 | 8/12 |
| `lynx02-04` | gpu | GTX 1080 Ti | 6.1 | 11.3 | broadwell | 8, 16 | 6/12 |
| `ai05_ai10` | gnolim | GTX 1080 | 6.1 | 8.2 | skylake | 8, 16 | 4/12 |
| `jinx01-02` | gnolim | GTX 1080 | 6.1 | 8.2 | haswell | 8, 16 | 4/12 |
| `titanx03` | gnolim | Titan X | 5.2 | 12.3 | haswell | 8 | 3/12 |
...
| `jaguar03` | RTX A4500 | 8 | 0.0264 | 9.94 | 19,414 | 0.014 | 1.7 | 0.07% |
...
| `jaguar03` | RTX A4500 | 8 | 0.0496 | 10.58 | 10,329 | 0.027 | 3.2 | 0.05% |
...
| `ai06` | RTX 2080 Ti | 16 | 0.1427 | 7.35 | 3,588 | 0.077 | 9.5 | 0.12% |
...
| `affogato13-15` | GTX 1080 Ti | 8 | 0.2309 | 4.54 | 2,217 | 0.125 | 9.5 | 0.30% |
...
| `jaguar03` | RTX A4500 | 512 | 26.4 | 26.4 | not yet | N/A | 0.2% |
| `jaguar03` | RTX A4500 | 1024 | 49.6 | 49.6 | not yet | N/A | 0.1% |
| `jaguar03` | RTX A4500 | 2048 | 95.1 | 95.1 | not yet | N/A | 0.0% |
...
| `ai01-04_lynx10` | RTX 2080 Ti | 2048 | 143.2 | 143.1 | N/A | 30, not yet | 0.0% |
| `ai06` | RTX 2080 Ti | 512 | 38.8 | 38.9 | N/A | 30, 38.7 | 0.4% |
| `ai06` | RTX 2080 Ti | 1024 | 73.0 | 73.0 | N/A | 30, 73.1 | 0.1% |
| `ai06` | RTX 2080 Ti | 2048 | 142.8 | 142.7 | N/A | 30, not yet | 0.1% |
...
| `lynx05-07` | Tesla P100 | 2048 | 239.5 | 240.0 | N/A | 30, not yet | 0.2% |
| `lynx01` | Titan Xp | 512 | 55.5 | 55.8 | N/A | 30, not yet | 0.5% |
| `lynx01` | Titan Xp | 1024 | 103.9 | 105.0 | N/A | 30, not yet | 1.1% |
| `lynx01` | Titan Xp | 2048 | 203.6 | 204.0 | N/A | 30, not yet | 0.2% |
| `affogato13-15` | GTX 1080 Ti | 512 | 61.4 | 61.6 | N/A | 30, not yet | 0.4% |
| `affogato13-15` | GTX 1080 Ti | 1024 | 116.0 | 116.2 | N/A | 30, not yet | 0.1% |
| `affogato13-15` | GTX 1080 Ti | 2048 | 230.9 | 231.1 | N/A | 30, not yet | 0.1% |
| `ai07-08` | GTX 1080 Ti | 512 | 62.0 | 62.2 | N/A | 30, 60.8 | 2.4% |
| `ai07-08` | GTX 1080 Ti | 1024 | 117.2 | 117.3 | N/A | 30, 114.8 | 2.2% |
| `ai07-08` | GTX 1080 Ti | 2048 | 227.9 | 229.8 | N/A | 30, not yet | 0.9% |
| `ai09` | GTX 1080 Ti | 512 | 62.0 | 62.2 | N/A | 30, 61.0 | 1.9% |
| `ai09` | GTX 1080 Ti | 1024 | 117.2 | 117.3 | N/A | 30, 114.6 | 2.3% |
| `ai09` | GTX 1080 Ti | 2048 | 232.3 | 226.5 | N/A | 30, not yet | 2.6% |
| `lynx02-04` | GTX 1080 Ti | 512 | 60.5 | 60.6 | N/A | 30, not yet | 0.1% |
| `lynx02-04` | GTX 1080 Ti | 1024 | 113.4 | 114.3 | N/A | 30, not yet | 0.8% |
| `lynx02-04` | GTX 1080 Ti | 2048 | 226.1 | 223.2 | N/A | 30, not yet | 1.3% |
...
- `jaguar03` at 32 processors (RTX A4500, partition gpu)
- `cheetah08-09` at 8 processors (RTX A4000, partition gpu)
...
- `affogato11` at 8 processors (RTX 2080 Ti, partition gpu)
...
- `lynx01` at 30 processors (Titan Xp, partition gpu)
- `affogato13-15` at 30 processors (GTX 1080 Ti, partition gpu)
- `lynx02-04` at 30 processors (GTX 1080 Ti, partition gpu)
